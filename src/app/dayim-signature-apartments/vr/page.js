...
function VR() {
  ...
  return (
    <div className='flex items-center justify-center'>
        ...
        <div className='h-screen w-full relative overflow-hidden '>
            ...
            <div className='absolute h-full w-full top-0 flex items-center justify-center text-white text-6xl z-10'>
                <button 
                    ...
                    className={`flex items-center justify-center bg-second py-5 w-[250px] gap-5 hover:scale-110 transition ${showVrModal && 'hidden'}`}>
        ...
        <div className='absolute bottom-0 left-0 w-full hidden 
          ...
          <div className='flex items-center justify-between w-full'>
            <div className='flex'>
              ...
              <div className='h-[100px] w-[100px] bg-white'></div>
              <div className='h-[100px] w-[100px] bg-gray opacity-60'></div>
              <div className='h-[100px] w-[100px] bg-gray opacity-40'></div>
              <div className='h-[100px] w-[100px] bg-gray opacity-40'></div>
              <div className='h-[100px] w-[100px] bg-gray opacity-40'></div>
            </div>
            <div className='flex'>
        ...
        <div className={`z-10 absolute top-0 h-screen w-[95%] ${showVrModal ? 'flex' : 'hidden'} transition flex-col items-center justify-center  
                        lg:w-[70%]`}
        >
            <h3 className='text-white  text-3xl font-bold w-[80%] text-center  mb-10
                            md:mt-28 lg:w-[40%]'
            >
