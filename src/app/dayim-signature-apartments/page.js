  ...
  return (
    <div>
        ...
        <div>
          <motion.div 
            ...
            <p className='w-[90%] text-lg text-gray font-semibold '>
                            DAYIM SIGNATURE APARTMENT is a high-end luxury apartment, being developed by DAYIM MARKETING. Given its location in one of the central neighborhoods of Lahore, the residents of this project will be surrounded by all the main attractions of the city. <br/>

                            DAYIM SIGNATURE APARTMENT is an LDA - approved project provides contemporary, elegant and spacious living spaces that are designed to cater to the urbanities’ modern lifestyle, complemented with traditional values of living.<br/>

                            The exquisite studio and one bedroom apartment of DAYIM SIGNATURE APARTMENT, come with a separate kitchen, lounge that are designed to exude luxurious sophistication. There is an easy instalment plan for these apartments, which will help you secure these ideal accommodations where you can create new beginnings for you and your loved ones.
            </p>            
            <Link href="/about" className='flex items-center justify-center border-2 border-gray py-3 w-[250px] my-5 hover:scale-110 transition'>
                <span className=' text-xl font-bold '>More About Us</span>
            </Link>
          </motion.div>
          <motion.div 
            initial="hide"
      ...
      <motion.section
        ...
        <p className='text-center text-lg text-first 
                      md:w-[550px]'>Choose the right apartment for your needs, taste, and possibilities.</p>        
        <HomeTab />
      </motion.section>
      ...
      <motion.section 
        ...
        className='w-full p-5 bg-bg1 bg-center bg-no-repeat bg-cover
                          lg:pl-[200px]'>
        <h3 className='text-4xl text-second font-bold'>World-class Architecture</h3>
       
        <div className='flex items-start pt-10 flex-col 
                        lg:flex-row'>
          <div className=' text-lg font-semibold w-[100%] p5
                          lg:w-[35%]'>
      ...
      <motion.section 
        ...
        <h3 className='text-5xl text-second font-bold text-center my-10 '>Facilities & Amenities</h3>
