  ...
  return (
    <div>
      ...
      <div className='bg-home-banner bg-center bg-no-repeat h-[400px] flex flex-col items-center justify-center gap-3'>
        <h3 className='text-[#d7ad4b] text-2xl font-bold uppercase text-center
                      lg:text-4xl'>Dayim Signature Apartments</h3>
        <h4 className='font-semibold text-2xl text-center uppercase letter tracking-widest	'>Modern Living</h4>
        <p className='text-center tracking-widest text-2xl font-Tangerine 
                      lg:text-4xl'>
        ...
        <button className='bg-[#d7ad4b] px-5 py-2 rounded-md uppercase font-semibold hover:bg-white hover:text-[#d7ad4b]'>Contact us</button>
      </div>
      {/* banner ends */}
      ...
      {/* sub banner starts */}
      <div>
        <p className='bg-[#7c7c7c]  font-semibold p-2 text-center 
                      lg:p-5 lg:text-3xl'>
          Choose The Dayim For <span className='text-[#d7ad4b]'>Best Deals</span>
        </p>
      </div>
      {/* sub banner ends */}

      {/* section 2 starts */}
      <div className='grid grid-cols-1 p-5 items-center justify-center gap-10
                      lg:px-[200px] lg:py-10 md:grid-cols-2'>
        <div className='space-y-5 text-sm'>
          <h2 className='font-bold text-2xl capitalize'>Welcome To Dayim Signature Apartments</h2>
          <p>DAYIM SIGNATURE APARTMENT is a high-end luxury apartment, being developed by DAYIM MARKETING. Given its location in one of the central neighborhoods of Lahore, the residents of this project will be surrounded by all the main attractions of the city.</p>
          <p>DAYIM SIGNATURE APARTMENT is an LDA - approved project provides contemporary, elegant and spacious living spaces that are designed to cater to the urbanities’ modern lifestyle, complemented with traditional values of living.</p>
          <p>The exquisite studio and one bedroom apartment of DAYIM SIGNATURE APARTMENT, come with a separate kitchen, lounge that are designed to exude luxurious sophistication. There is an easy instalment plan for these apartments, which will help you secure these ideal accommodations where you can create new beginnings for you and your loved ones.</p>
        </div>
      ...
      {/* section 3 starts */}
      <div className='bg-bg2 bg-center bg-no-repeat grid grid-cols-1 p-5 items-center justify-center gap-10
                      lg:px-[200px] lg:py-10 md:grid-cols-2'>
        ...
        <div className='text-sm px-10'>
          <h3 className='text-2xl uppercase tracking-widest font-bold'>Location</h3>
          <h4 className='text-xl font-semibold'>The Most Convenient & Premium</h4>
      ...
      {/* sub banner starts */}
      <div>
        <p className='bg-[#7c7c7c]  font-semibold p-2 text-center uppercase text-[#d7ad4b] 
                      lg:p-5 lg:text-3xl'>
      ...
      {/* section 4 starts */}
      <div className='grid grid-cols-1 p-5 items-center justify-center gap-10 bg-bg1 bg-center bg-no-repeat
      ...
      <div className='grid grid-cols-1 p-5 gap-10
        ...
        <div className='relative'>
          ...
          <span className='absolute top-[85%] right-0 bg-[#d7ad4b] px-14 py-3 text-white font-bold text-xl'>Bedroom</span>
        </div>
        <div className='relative'>
          <img src="/images/b2.png" className='w-full h-full' />
          <span className='absolute top-[85%] right-0 bg-[#d7ad4b] px-14 py-3 text-white font-bold text-xl'>Lounge</span>
        </div>
      ...
      <div className='grid grid-cols-1 p-5 gap-10
        ...
        <div className='relative'>
          ...
          <span className='absolute top-[85%] right-0 bg-[#d7ad4b] px-14 py-3 text-white font-bold text-xl'>KITCHEN</span>
        </div>
        <div className='relative'>
      ...
      <div className='grid grid-cols-1 p-5 gap-10
        ...
        <div className='relative'>
          ...
          <span className='absolute top-[85%] right-0 bg-[#d7ad4b] px-14 py-3 text-white font-bold text-xl'>Bathroom</span>
        </div>        
      </div>
      {/* section 5 sub section 1 ends */}
      ...
      <div className='grid grid-cols-1 p-5 items-center justify-center gap-10 bg-bg1 bg-center bg-no-repeat
        ...
        <div className='space-y-5 text-sm
          ...
          <p>
            An exquistic cafe / Chef&apos;s Kitchen with a spacious in-door seating along with outdoor seating area has been provided to support your busy life style. From quick meals delivered to your apartments, to casual dine-in and BBQ Nights with your family and friends or just a coffee or snacks for your guests, the on-site CAFE is there to meet your needs.
          </p>          
        </div>
      ...
      <div className='p-5'>
        ...
        <div className='grid grid-cols-1 items-center mt-10
          ...
          <div className='flex flex-col items-center justify-center gap-2'>
            ...
            <p className='text-center'>24/7 security ensuring security for residents</p>
          </div>
          ...
          <div className='flex flex-col items-center justify-center gap-2'>
            ...
            <p className='text-center'>Emergency efficient lighting with LED&apos;s sensors lights </p>
          </div>
        </div>
      </div>
      {/* section 7 ends */}
      ...
      <div className='p-5 bg-black text-white'>        
        <div className='grid grid-cols-1 items-start justify-center mt-10 gap-5
                        md:grid-cols-3 lg:grid-cols-5'>
          <div className='flex flex-col items-center justify-center'>
            <h3 className='font-bold text-xl text-[#d7ad4b]'>HEAD OFFICE</h3>
            <p className='text-center mt-3'>66-B, 3/F MAIN COMMERCIAL SECTOR C, BAHRIA TOWN, LAHORE.</p>
          </div>

          <div className='flex flex-col items-center justify-center'>
            <h3 className='font-bold text-xl text-[#d7ad4b]'>SITE OFFICE</h3>
            <p className='text-center mt-3'>46-47, BROADWAY COMMERCIAL, AL KABIR TOWN PHASE2.</p>
          </div>

          <div className='flex flex-col items-center justify-center'>
            <h3 className='font-bold text-xl text-[#d7ad4b]'>USA OFFICE</h3>
            <p className='text-center mt-3'>Suite # 368, 30 lake avenue Riverhead, NY, 11901.</p>
          </div>
          ...
          <div className='flex flex-col items-center justify-center'>
            <h3 className='font-bold text-xl text-[#d7ad4b]'>24/7 SALES CENTRE</h3>
