    ...
    <div>
      ...
      <div className='h-[400px] w-full relative overflow-hidden
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10
           ...
           <div className='lg:mt-[-50px]'>
            <h2 className='text-white font-bold  w-[300px] text-3xl text-center mt-10
                            md:text-left lg:text-7xl md:text-5xl md:w-[450px] md:mt-0'>City living with a touch of nature</h2>
            <div className=' flex flex-col md:flex-row items-center gap-5
                            md:gap-20 md:mt-10'>
              <div className='hidden md:block'>
                <h3 className='text-white font-bold text-2xl'>Explore DSA</h3>
                <Link href="/dayim-signature-apartments#section2" className='text-gray font-semibold text-lg hover:text-white ' >Scroll down</Link>
              </div>
              <Link href="/dayim-signature-apartments/vr" className='flex items-center justify-center border-2 border-white py-3 w-[250px] gap-5 hover:scale-110 transition
                                              '>
                <img src="/images/dsa/vr-icon.svg" className='object-contain h-[20px] ' />
                <span className='text-white text-xl font-bold'>Explore in VR</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <motion.section         
        ...
        className='grid grid-cols-1 
                         lg:grid-cols-4'>
        <div className='flex flex-row items-center justify-start gap-10 px-10 h-[150px]  border-t border-gray relative group
            ...
            <h3 className='text-xl font-semibold z-10 group-hover:text-white  tracking-wider'>Live Better</h3>
        </div>
        ...
        <div className='flex flex-row items-center justify-start gap-10 px-10 h-[150px]  border-t border-gray relative group
            ...
            <img 
                ...
                className='z-10  h-[70px] w-[70px]
                            lg:h-[120px] lg:w-[120px]'  />
            <h3 className='text-xl font-semibold z-10 group-hover:text-white  tracking-wider'>Live Naturally</h3>
        </div>
        ...
        <div className='flex flex-row items-center justify-start gap-10 px-10 h-[150px]  border-t border-gray relative group
            ...
            <img 
                ...
                className='z-10  h-[70px] w-[70px]
                            lg:h-[120px] lg:w-[120px]'  />
            <h3 className='text-xl font-semibold z-10 group-hover:text-white  tracking-wider'>Live Fully</h3>
        </div>
        ...
        <div className='flex flex-row items-center justify-start gap-10 px-10 h-[150px]  border-t border-gray relative group
            ...
            <img 
                ...
                className='z-10  h-[70px] w-[70px]
                            lg:h-[120px] lg:w-[120px]'  />
            <h3 className='text-xl font-semibold z-10 group-hover:text-white  tracking-wider'>Live Carefree</h3>
        </div>
      </motion.section>
      ...
      <section
        ...
        >
          ...
          >
            DAYIM SIGNATURE APARTMENT is the best residential project in Pakistan. It combines modern lifestyle and urban dynamics with the views of nature.
          </p>
        </motion.div>
      </section>
        ...
        <div>
          <motion.div 
            ...
            <p className='w-[90%] text-lg text-gray font-semibold 
                          lg:w-[60%]'>
                          The Studio and One Bedroom Apartments offered by DAYIM SIGNATURE APARTMENT are designed to be spacious and contemporary, while still maintaining traditional values of living. The separate kitchen and lounge areas add to the luxurious feel of the apartments, and the attention to detail in the design is sure to impress.</p>            
            <Link href="/dsa/residences" className='flex items-center justify-center border-2 border-gray py-3 w-[250px] my-5 hover:scale-110 transition'>
          ...
          <motion.div 
            ...
            className='mt-10 hidden h-[500px]  
                          lg:inline-block '>
            <img src="/images/dsa/about/2.png" className='object-cover w-full h-full' alt="" />
          </motion.div>
        </div>
      </section>
      ...
      >        
        <div className='absolute h-full w-full bg-second bg-opacity-80 flex items-start justify-center'>
          <div className='w-[80%] flex flex-col gap-10 mt-[100px] text-white
                          lg:w-[70%]'>
              <h3 className='text-5xl font-bold  '>Excellent location</h3>
              <p className='text-lg w-[100%] 
                            lg:w-[40%]'>DAYIM SIGNATURE APARTMENT is an LDA - approved project provides contemporary, elegant and spacious living spaces that are designed to cater to the urbanities’ modern lifestyle, complemented with traditional values of living.</p>
              <Link href="https://goo.gl/maps/cz95XeTvzZ4RVryh9" target='_blank' className='text-lg underline font-semibold hover:text-first'>View map</Link>
          </div>
        </div>        
      </motion.section>
      ...
      <motion.section 
        ...
        <div className='flex flex-col gap-10 items-center justify-center px-10'>
          ...
          <Link href="/dsa/residences" className='py-4 px-8 mb-20 border-2 border-gray hover:scale-110 transition'>Explore</Link>
        </div>
      </motion.section>
