...
import FooterSlider1 from '../sliders/FooterSlider1';
...
function Footer1() {
    ...
    <div className='bg-black text-white min-h-[500px]
        ...
        <motion.section 
            ...
            <h3 className='w-[100%] text-6xl font-bold 
                            lg:w-[50%] lg:text-center text-second'>Developer</h3>
            <div className='w-[100%] text-gray  text-lg text-justify
                            lg:w-[50%] md:pr-[200px]'>
                <p><Link href="/" className='text-second'>DAYIM MARKETING</Link> is a team of specialists - engineers, architects, project managers, technicians and other experts, all of whom share a common goal: a positive and responsible development of the city that takes into account the wellbeing of its people and the environment.</p>
                <div className='flex flex-col gap-5 items-center mt-10
                    ...
                    <div className=' flex gap-5'>
                        <Link href="https://www.facebook.com/dayimmarketing/" target='_blank'>                            
                            ...
                            <img src="/images/dsa/icons/facebook.svg" alt="" className='w-[30px] h-[30px] hover:scale-110' />
                        </Link>
                        <Link href="https://www.instagram.com/Dayimmarketing/" target='_blank'>
                            <img src="/images/dsa/icons/instagram.svg" alt="" className='w-[30px] h-[30px] hover:scale-110' />
                        </Link>                        
                        <Link href="https://www.youtube.com/c/DayimMarketing" target='_blank'>
                            <img src="/images/dsa/icons/youtube.svg" alt="" className='w-[30px] h-[30px] hover:scale-110' />
                        </Link>                  
                        ...
                        <Link href="https://www.twitter.com/Dayimmarketing" target='_blank'>
                            <img src="/images/dsa/icons/twitter.svg" alt="" className='w-[30px] h-[30px] hover:scale-110' />
                        </Link>                  
                        <Link href="https://api.whatsapp.com/send?phone=923085111176" target='_blank'>
                            <img src="/images/dsa/icons/whatsapp.png" alt="" className='w-[30px] h-[30px] hover:scale-110' />
                        </Link>                  
                    </div>
                </div>
            </div>
