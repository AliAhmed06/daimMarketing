      ...
      <section className="my-[50px] mt-[150px] px-10 md:px-32 ">
        ...
        <ul className="list-decimal ml-[30px] text-lg flex flex-col gap-5">
          <li>
            ...
            confirmed only after receiving the down payment. All payments shall
            be made in favor of Developers via Online, Cash, or any other
            sources provided by the Developer.
          </li>
          <li>
            The possession and ownership of the Unit shall remain with Developer
            until full payment, including service charges for utilities and
            documentation charges, is made by the Applicant (s).
          </li>
          <li>
          ...
          <li>
            ...
            monthly service charges for maintenance and administrative cost. The
            costs will be charged according to the total area of the Unit.
          </li>
          <li>
            If the Applicant wishes to transfer or sell their Unit, they made it
            according to SOPs as prescribed by the Developer, and Developer will
            charge a transfer fee according to the size of the Unit with only
            eligible for transfer provided that its installments and other dues
            are cleared until the date of transfer. Any transfer without the
            involvement of the Developer shall be considered void.
          </li>
          <li>
            ...
            towards the Unit they have booked, the same will be refunded to them
            within three months. There will be no deduction made against the
            refund or surrender. The payment will be refunded through the same
            channel by which the applicant booked the unit.
          </li>
          <li>
          ...
          <li>
            ...
            inform Developer in writing about the difference within 15 days. In
            case of recovery, default, or cancellation, the address mentioned in
            the application form shall be treated as the final address. The
            Developer shall send all addresses through registered post
            acknowledgment due to urgent mail service and renowned courier
            service. Non-availability reported by the above agencies of the
            Applicant (s) at the address given shall be deemed valid service of
            the notice/letter.
          </li>
          <li>
          ...
          <li>
            No claim otherwise will be made on Developer by the Applicant (s) if
            the Developer interrupts the construction work or is unable to keep
            the schedule due to Force majeure, war, natural calamities, civil
            unrest, labor strikes, or any other event over which Developer has
            no power.
          </li>
          <li>
            The total area of the Unit consists of the area as prescribed in the
            booking form and shares in a common area. The size will vary
            according to the unit type, but the parking area and share in the
            common area will remain the same.
          </li>
          <li>
            The Developer and Applicant (s) will be bounded by a contract after
            booking. That contract will address the specification of the Unit in
            detail.
          </li>
          <li>
          ...
          <li>
            ...
            from the announcement to this effect. It is clearly understood that
            in such eventuality, the Applicant (s) will not claim any interest
            or damage of whatsoever nature from the Developer.
          </li>
          <li>
            The Developer shall remain the exclusive honor of the entire Roof
            Space, and no applicant(s) shall claim any rights of any nature upon
            the Roof Space.
          </li>
          <li>
          ...
          <li>
            ...
            life of the Applicant(s) and other residents. In exceptional cases,
            permission from the Developer is deemed necessary.
          </li>
          <li>
          ...
          <li>
            The Applicant (s) shall maintain the Unit at their own cost in good
            condition that it will not harm other units and shall not do any act
            to endanger, damage, or impair the building and the common area of
            the building. The Applicant (s) shall abide by the rules and
            regulations of authoritative bodies.
          </li>
          <li>
          ...
          <li>
            The Developer reserves the right to cancel the agreement in case of
            breach of any terms and conditions by the Applicant(s).
          </li>
          <li>
