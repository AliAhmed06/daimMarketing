    ...
    <div>
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10'>
          <div className=' w-[60%]  mx-auto flex flex-col items-center justify-center gap-5'>
            ...
            <h2 className='text-white font-bold  w-full text-3xl text-center mt-[-20px] 
                            lg:text-4xl md:text-4xl  md:mt-0'>Maryam Town </h2>            
            <Link href="/images/dayimMarketing/societies/al-kabir/maps/maryum-town-Map.pdf" target='_blank' className='border-2 border-white py-3 px-8 text-white font-bold text-xl hover:scale-110 transition'>              
              Download Map
            </Link>
          </div>
        </div>
      ...
      >
        ...
        <p className=' text-xl text-gray text-justify w-[80%]
                        lg:w-[60%]'>
                          Maryam Town, a new real estate venture by Al Kabir Developers, is being introduced as an affordable and well-planned housing project located in a prime area of Lahore. With its unique features and attention to detail, Maryam Town aims to provide residents with a once-in-a-lifetime living experience. <br />
                          The project offers a comprehensive lifestyle with a range of amenities, ensuring that residents can enjoy a contemporary and comfortable lifestyle. Maryam Town is designed to cater to the needs and aspirations of its residents, offering quality living spaces at an affordable price.<br />
                          Being LDA-approved, Maryam Town provides a sense of security and legitimacy to potential buyers. The involvement of world-class developers in this project further adds to its credibility and makes it a recommended choice for both residents and tourists looking for a stylish and comfortable living experience.<br />
        </p>
      </motion.section> 
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
          ...
          <p className='text-gray'>
            Maryam Town is an exquisite real estate living experience that promises green living in a peaceful landscape. This residential society is located on Main Raiwind Road near Bahria Orchard Lahore and Kings Town Lahore. This is easily accessible from Thokar Niaz Baig which is just at a distance of 3-4 km. You can also reach out to this luxurious real estate opportunity from Multan Road, Ring Road Lahore as well as canal road.
          </p>          
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
          ...
          <p className='text-gray'>
            Maryam Town is phase 4 of Al Kabir Town. A project is established by seasoned construction firms Al-Kabir Developers. <br />
            Phase 1 of Al Kabir Town, a world-class housing society was launched in December 2016. After the huge success of the first phase, second and third phases were introduced and later, they decided to extend their efforts in the form of Maryam Town.<br />
            The four phases Al Kabir Developers introduced are as follows:<br />
          </p>          
          <ul className='ml-[50px] list-disc text-gray'>
