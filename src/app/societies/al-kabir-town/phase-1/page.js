    ...
    <div>
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10'>
          <div className=' w-[60%]  mx-auto flex flex-col items-center justify-center gap-5'>
            ...
            <h2 className='text-white font-bold  w-full text-3xl text-center mt-10 
                            lg:text-5xl md:text-4xl  md:mt-0'>Al Kabir Town Phase 1</h2>
            
            <Link href="/images/dayimMarketing/societies/al-kabir/maps/Al-Kabir-Town-Ph-1-Map.pdf" target='_blank' className='border-2 border-white py-3 px-8 text-white font-bold text-xl hover:scale-110 transition'>              
              Download Map
            </Link>
          </div>
        </div>
      ...
      >
        ...
        <p className=' text-xl text-gray text-justify w-[80%]
                        lg:w-[60%]'>Al Kabir Town, developed by Al Kabir Developers, is a well-designed community located on Main Raiwind Road in Lahore. Spanning over an expansive 2,500 Kanal land, it offers a large area for residential and commercial developments.<br />
                            The town consists of  its own set of blocks, including A, B, C, and D. Phase I of Al Kabir Town was launched in 2016, followed by the launch of apartments in March 2017.<br />
                            One of the significant advantages of Al Kabir Town is that all phases have obtained approval from the Lahore Development Authority (LDA). This approval ensures that the development meets the necessary standards and regulations set by the authority.<br />
                            Al Kabir Town aims to provide luxury and modern living spaces to the residents of Lahore at an affordable price. With its ideal location on Main Raiwind Road and its commitment to creating an aesthetically pleasing community, it seeks to offer a comfortable and convenient lifestyle for its residents.                        
                        </p>
      </motion.section>
