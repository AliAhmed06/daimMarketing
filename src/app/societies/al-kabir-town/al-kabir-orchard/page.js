      ...
      <div className='h-[400px] w-full relative overflow-hidden
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10'>
          <div className=' w-[60%]  mx-auto flex flex-col items-center justify-center gap-5'>
            ...
            <Link href="/contact" target='_blank' className='border-2 border-white py-3 px-8 text-white font-bold text-xl hover:scale-110 transition'>              
              Contact Us
            </Link>
          </div>
        </div>
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
          ...
          <p className='text-gray'>
            Al Kabir Developers are a well-renowned developer in the real estate industry, known for their unique and affordable projects. Their main goal is to provide individuals with limited budgets the opportunity to own their dream homes and live comfortably. With this mission in mind, the Al Kabir Developers have successfully completed 7 real estate projects in Lahore, earning a reputation for fulfilling their commitments to clients and delivering projects on time. This Project is their latest development that promises to be a great addition to their portfolio of successful projects. They are committed to providing their clients with quality homes and outstanding customer service, making it a preferred choice for many customers looking for a place to call home. <br /><br />
            The Al Kabir Developers have delivered the following projects in Lahore:
          </p>          
        ...
        <div className='w-[90%] h-full flex items-center justify-center
                        lg:w-[40%]'>
          <img src="/images/dayimMarketing/societies/al-kabir/al-kabir-orchard/gallery-1.jpg" alt="" className='h-full w-full lg:h-[400px]  rounded-md object-cover' />
        </div>
      </motion.section>
