    ...
    <div>
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
                        lg:w-[60%]'>
          <h3 className='font-bold text-4xl '>Kings Town Lahore NOC and PP1</h3>
          <p className='text-gray'>
          It is good news for all the eager customers that Kings town Lahore is an LDA approved housing society. Thus it is a safe investment opportunity for all those who wish to earn a stable revenue. <br />
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
          ...
          <ul className='ml-[50px] list-disc text-gray'>
            ...
            <li>3 min drive from Ring Road</li>
            <li>12 min Drive from Allama Iqbal International Airport</li>
          </ul>
          <p className='text-gray'>
            Fortunately, this land development is good news to everyone who dreams to build the luxury of their own living space at aﬀordable prices.
          </p>
        </div>
      ...
      >        
        <div className='w-[90%] mx-auto flex flex-col items-center justify-center'>
            ...
            <Link href={"/contact"}>
              <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan1.jpg" alt="" className='lg:h-[1000px] lg:w-[1000px] object-cover' />
            </Link>
        </div>        
      </motion.section>
      ...
      >        
        <div className='w-[90%] mx-auto flex flex-col items-center justify-center'>
            ...
            <Link href={"/contact"}>
              <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan2.jpg" alt="" className='lg:h-[1000px] lg:w-[1000px] object-cover' />
            </Link>
        </div>        
      </motion.section>
      ...
      >        
        <div className='w-[90%] mx-auto flex flex-col items-center justify-center'>
            <div className='text-center text-xl text-second py-10'>
              <h3 className='font-bold text-4xl text-center text-second'>Payment Plan</h3>            
              <h4>Awais Qarni Block</h4>              
            </div>
            <Link href={"/contact"}>
              <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan3.jpg" alt="" className='lg:w-[1000px] object-contain' />
            </Link>
        </div>        
      </motion.section>
