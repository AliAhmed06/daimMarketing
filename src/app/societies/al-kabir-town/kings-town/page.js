    ...
    <div>
      ...
      >
        ...
        <p className=' text-xl text-gray text-justify w-[80%]
                        lg:w-[60%]'>
                          King&apos;s Town, a residential estate in Lahore developed by Al-Kabir Developers. It appears to be a well-planned and economically viable housing scheme, offering 3 & 5 Marla Residential Plots, fully constructed houses, and various commercial plots.<br />
                          The success of previous projects by Al-Kabir Developers, such as Al-Kabir Town Phase-I and Phase-II, adds to the credibility of King&apos;s Town, which is considered Phase-III of Al-Kabir Town. The developers have recently launched King&apos;s Town sector B, indicating further expansion of the project. They have also introduced a new payment plan specifically for the 3 Marla commercial plots in Sector B.<br />
                          One significant aspect of King&apos;s Town is its authenticity, as it is approved by the Lahore Development Authority (LDA). This approval ensures that the project meets the necessary standards and regulations. Furthermore, Al-Kabir Developers guarantee timely delivery of the project, instilling confidence in potential buyers and investors.<br />
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
                        lg:w-[60%]'>
          <h3 className='font-bold text-4xl '>King&apos;s Town Phase 1 Location</h3>
          <p className='text-gray'>
          It is good news for all the eager customers that King&apos;s town Lahore is an LDA approved housing society. Thus it is a safe investment opportunity for all those who wish to earn a stable revenue. <br />
          Furthermore, Al-Kabir developers have the total land endorsement rights reserved even before the commencement of the project. This special feature has made this housing society a secure venture for all the investors out there. <br />
          ...
          <ul className='ml-[50px] list-disc text-gray'>
            ...
            <li>Next to Bahria Orchard Lahore, and nearest to Superior University</li>
          </ul>
        </div>
      ...
      >        
        <div className='w-[90%] mx-auto flex flex-col items-center justify-center'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-7'>
              <Link href={"/contact"}>
                <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan1.jpg" alt="" className='h-full w-full' />
              </Link>
              <Link href={"/contact"}>
                <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan2.jpg" alt="" className='h-full w-full' />
              </Link>
              <Link href={"/contact"}>
                <img src="/images/dayimMarketing/societies/al-kabir/kings-town/payment-plan3.jpg" alt="" className='h-full w-full' />
              </Link>
            </div>            
        </div>        
      </motion.section>
