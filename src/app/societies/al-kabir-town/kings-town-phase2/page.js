    ...
    <div>
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex items-center justify-center
                        lg:w-[40%]'>
          <img src="/images/dayimMarketing/societies/al-kabir/kings-town2/gallery-1.jpg" alt="" className='h-full w-full lg:h-[400px]  rounded-md object-cotain' />
        </div>
      </motion.section>
      ...
      <motion.section 
        ...
        <div className='w-[90%] h-full flex items-center justify-center
                        lg:w-[40%]'>
          <img src="/images/dayimMarketing/societies/al-kabir/kings-town2/gallery-6.jpg" alt="" className='h-full w-full lg:h-[400px]  rounded-md object-contain' />
        </div>
        <div className='w-[90%] h-full flex flex-col items-start justify-center gap-5
                        lg:w-[60%]'>
