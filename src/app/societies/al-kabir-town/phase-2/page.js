    ...
    <div>
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10'>
          <div className=' w-[60%]  mx-auto flex flex-col items-center justify-center gap-5'>
            ...
            <h2 className='text-white font-bold  w-full text-3xl text-center mt-10 
                            lg:text-5xl md:text-4xl  md:mt-0'>Al Kabir Town Phase 2</h2>
            
            <Link href="/images/dayimMarketing/societies/al-kabir/maps/Al-Kabir-Town-Ph-2-Map.pdf" target='_blank' className='border-2 border-white py-3 px-8 text-white font-bold text-xl hover:scale-110 transition'>              
              Download Map
            </Link>
          </div>
        </div>
      ...
      >
        ...
        <p className=' text-xl text-gray text-justify w-[80%]
                        lg:w-[60%]'>
                          Al Kabir Town Phase 2 is strategically located on Raiwind Road, precisely opposite the Main Boulevard of Lake City. This location is considered more ideal and strategic, offering a genuine blend of modern architecture and serene green surroundings. The location map indicates that it provides a peaceful environment for residents.<br />
                          Moreover, Al Kabir Town Phase 2 has received approval from the Lahore Development Authority (LDA), further enhancing its credibility and making it a worthy investment option.<br />
                          The payment plan for Al Kabir Town Phase 2 in 2023 includes residential and commercial plots of various sizes, such as 3 Marla, 5 Marla, 7 Marla, and 8 Marla. These plots are equipped with all the necessary facilities and amenities to provide a world-class lifestyle to residents.<br />
                          Additionally, MCB (Muslim Commercial Bank) has opened a new branch on the Main Boulevard of Al Kabir Town Phase 2, which adds convenience and accessibility to the residents and investors.<br />
                          Overall, Al Kabir Town Phase 2 aims to offer an affordable dream lifestyle to everyone, ensuring that individuals from various backgrounds can enjoy the benefits and facilities of this well-planned community.
                        </p>
      </motion.section>
        ...
        <div className='w-[80%] mx-auto text-center  '>
            ...
            <div className='grid grid-cols-1 mt-10 gap-5
                ...
                <BoxItem 
                  ...
                  text={"Electricity and water are the basic necessities of life. The developers have made sure that the residents do not face any issues from this end. To ensure the electricity supply 24/7, developers have provided underground wiring. Moreover, water filtrations are also installed in the society to ensure a clean water supply."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Shopping Center"}
                  text={"For leisure and to fulfill the shopping requirements of the residents, a shopping center is available too."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Gym"}
                  text={"There is a saying, Health is Wealth. The outstanding gym is also available in the housing scheme that has the latest equipment and tools for fitness freaks."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Masjid"}
                  text={"The beautiful mosque is constructed in society and has all the facilities to provide ease to the worshippers."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Power Backup"}
                  text={"Power backup is something that is mainly available in societies where plot prices are a bit high. However, in Al Kabir Town Lahore, they have their own power system with a backup power generator. The system ensures everyone receives electricity without interruption."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Health Facilities"}
                  text={"A world-class hospital is also present in the society that has modern machinery, and even emergency service is available for the residents."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Restaurant"}
                  text={"To satisfy the hunger cravings of the residents, restaurants are present in the society."} 
                  type={"one"}
                />

                <BoxItem 
                  heading={"Zoo"}
                  text={"Zoo to let your children see wildlife from near and get educated."} 
                  type={"one"}
                />                
            </div>
        </div>
      ...
      <motion.section 
        ...
        <div className='w-[80%] mx-auto text-center  '>
            ...
            <p className='md:w-[60%] text-center mx-auto mt-5 text-gray'>Following are the guidelines to follow while Purchasing/Sale of Plots in Al Kabir Town</p>
            <div className='grid grid-cols-1 mt-10 gap-5
                            md:grid-cols-2 lg:grid-cols-3'>
                <BoxItem 
      ...
      <motion.section 
        ...
        className='py-20 bg-white'>        
        <div className='w-[80%] mx-auto text-center  '>
            <h3 className='font-bold text-4xl'>Benefits of Investing in Al Kabir Town Lahore</h3>
            <p className='md:w-[60%] text-center mx-auto mt-5 text-gray'>
              There is not a single shadow of doubt on the prevailing importance of investing in real estate. This market is the most in-demand and promises both a stable income as well as profitable ROI.<br />
            ...
            <div className='grid grid-cols-1 mt-10 gap-5
                ...
                <BoxItem 
                  heading={"Financial Security"}
                  text={"In case you wish to make sure that your asset not only stays safe but also with the passage of time their worth increases then this sector is the ideal one to make an investment in."} 
                  type={"one"}
                />
                <BoxItem 
                  heading={"Stable Income"}
                  text={"Once you have made a purchase, you invest in it to develop it, and then you sell it. This is a cyclic process that ensures a stable source of income. You can also double the price value of a building by renting it out. All this ensures one single thing and that is a stable income."} 
                  type={"one"}
                />
                <BoxItem 
                  heading={"Manageable"}
                  text={"It is easier for a person to manage a real estate investment than any other investment that is out there. The best thing that you have to do is that you just have to visit it every once in a while to ensure that things are running smoothly there."} 
                  type={"one"}
                />
                <BoxItem 
                  heading={"Passive Income"}
                  text={"Whether you decide to buy a developed one or want to develop an otherwise open land, both of these can prove to be a good source of passive income. The rent that you might generate from these can become a steady source of income for the coming generations."} 
                  type={"one"}
                />
                <BoxItem 
                  heading={"Non-depreciable Asset"}
                  text={"Real estate is one of those sectors that will never lose its market value and can ensure a steady and stable return of investment no matter how bad the economy gets. Thus it is one of the most reassuring sectors to invest in at any time."} 
                  type={"one"}
                />
