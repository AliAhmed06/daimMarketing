    ...
    <div className='bg-black text-white min-h-[500px]
        ...
        <motion.section 
            ...
            <div className='w-[100%] text-gray  text-lg text-justify
                            lg:w-[50%] md:pr-[200px]'>
                <p><span className='text-second'>DAYIM MARKETING</span> is a team of specialists - engineers, architects, project managers, technicians and other experts, all of whom share a common goal: a positive and responsible development of the city that takes into account the wellbeing of its people and the environment.</p>
