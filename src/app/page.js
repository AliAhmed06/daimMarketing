    ...
    <div className='min-h-screen w-full '>
        ...
        <div className='absolute flex items-center top-0 h-full w-full px-[5%] z-10'>
          <div className=' w-[60%]  mx-auto flex flex-col items-center justify-center gap-5'>
            <h2 className='text-white font-bold  w-full text-3xl text-center mt-10 
                            lg:text-5xl md:text-4xl  md:mt-0'>Discover your place to live</h2>
      ...
      <motion.section 
        ...
        <div className='w-full h-full flex flex-col items-start justify-center gap-5
          ...
          <p>One of the leading firms in the real estate and marketing industry. Since 2021, we have been dedicated to providing exceptional services to thousands of clients, earning a reputation for excellence and reliability. We offer proficient and reliable consultancy services to both domestic and overseas customers. We understand that investing in real estate is a significant decision, and we are committed to guiding our clients through every step of the process.</p>
          <button className='bg-second py-3 px-8 rounded-md text-white uppercase hover:scale-110 transition'>Contact Us</button>
        </div>
